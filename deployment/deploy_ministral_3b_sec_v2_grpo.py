...
# ///
"""
Ministral-3-3B-Instruct-sec-v2-grpo: LoRA-adapted 3B model served via vLLM.

Deploys the base model mistralai/Ministral-3-3B-Instruct-2512-BF16 with a LoRA
adapter from llmtrace/Ministral-3-3B-Instruct-sec-v2-grpo via vLLM's --enable-lora.

Model details:
  - Base: mistralai/Ministral-3-3B-Instruct-2512-BF16 (Mistral3, 3B params, BF16)
  - Adapter: llmtrace/Ministral-3-3B-Instruct-sec-v2-grpo (LoRA r=32, alpha=64)
...
LoRA serving:
  ...
  - At inference, use model="ministral-3b-sec-v2-grpo" to route through the adapter,
...
Usage:
    ...
    cd deployment/
    uv run deploy_ministral_3b_sec_v2_grpo.py

Reference:
    https://huggingface.co/llmtrace/Ministral-3-3B-Instruct-sec-v2-grpo
...
ADAPTER_REPO = "llmtrace/Ministral-3-3B-Instruct-sec-v2-grpo"
ADAPTER_NAME = "ministral-3b-sec-v2-grpo"
...
if __name__ == "__main__":
    ...
    if deployment.state == "Ready":
        print()
        print(f"Ministral-3B-sec-v2-grpo deployment ready!")

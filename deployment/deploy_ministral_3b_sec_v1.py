...
# ///
"""
Ministral-3-3B-Instruct-sec-v1: LoRA-adapted 3B model served via vLLM.

Deploys the base model mistralai/Ministral-3-3B-Instruct-2512-BF16 with a LoRA
adapter from llmtrace/Ministral-3-3B-Instruct-sec-v1 via vLLM's --enable-lora.

Model details:
  - Base: mistralai/Ministral-3-3B-Instruct-2512-BF16 (Mistral3, 3B params, BF16)
  - Adapter: llmtrace/Ministral-3-3B-Instruct-sec-v1 (LoRA r=32, alpha=64)
...
LoRA serving:
  ...
  - At inference, use model="ministral-3b-sec-v1" to route through the adapter,
...
Usage:
    ...
    cd deployment/
    uv run deploy_ministral_3b_sec_v1.py

Reference:
    https://huggingface.co/llmtrace/Ministral-3-3B-Instruct-sec-v1
...
ADAPTER_REPO = "llmtrace/Ministral-3-3B-Instruct-sec-v1"
ADAPTER_NAME = "ministral-3b-sec-v1"
INSTANCE_NAME = "ministral-3b-sec-v1"
...
if __name__ == "__main__":
    ...
    if deployment.state == "Ready":
        print()
        print(f"Ministral-3B-sec-v1 deployment ready!")
